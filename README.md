...
Hacer curl al receiver usando el FQDN interno del mesh (TOMAR SCREENSHOT):
...
# Output esperado:
# *   Trying 10.x.x.x:80...
# * Connected to receiver.default.svc.cluster.local port 80 (#0)
# > GET / HTTP/1.1
...
✅ **PASO 8 completado:** Sender-VM → Receiver a través del mesh de Istio
